...
<html>
	<head>
		<title><? echo("$articleTitle"); ?> - ThreadBear Fiber Arts Studio</title>
	...
	<script>
			...
			Modified for this use by Matt Waldrop, 2008
			*/
			...
			function visibilitytoggle() {
				for (var i = 0; i < hotspots.length; i++) {
					...
					hotspots[i].onmouseover = function() {toggle(this.someProperty)};
					hotspots[i].onmouseout = function() {toggle(this.someProperty)};
					}
	...
	<body topmargin=0 leftmargin=0 marginheight="0" marginwidth="0" bgcolor=#000000 onLoad="visibilitytoggle()">
	
		<? include("../includes/logo.php"); ?>
		
	<!-- CONTENT -->
		<div class="content" style="position: absolute; left: 206px; top: 111px; width: 623px; height: 413;">
			<? include ("$articleFileName"); ?>		
		</div>
	
		<? 
			include("../includes/navigation/front_leftnav.php");
			include("$article_rightnav.php"); 
